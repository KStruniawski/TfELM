...
elm = ELMLayer(number_neurons=num_neurons, activation='mish', receptive_field_generator=rf, constrained=True)
model = ELMModel(elm)
...
model.save("Saved Models/RF-C-ELM_Model.h5")

# Load the saved model from the file
model = model.load("Saved Models/RF-C-ELM_Model.h5")
